...
import 'package:flutter_application_1/models/model_screen.dart';
import 'package:flutter_application_1/presentation/archive_screen.dart';
...
import 'package:flutter_application_1/presentation/shoping_screen.dart';
...
class AppCubit extends Cubit<CubitState> {
  ...
  Widget Img(int index) {
    if ((getItem[index].img! == 'images/food2.jpg') ||
        (getItem[index].img! == 'images/food1.jpg') ||
        (getItem[index].img! == 'images/food3.jpg') ||
        (getItem[index].img! == 'images/food4.jpg') ||
        (getItem[index].img! == 'images/food5.jpg')) {
      return ClipRRect(
  ...
  Widget ImgHistory(
    ...
    if ((gethistory[i][index].img! == 'images/food2.jpg') ||
        (gethistory[i][index].img! == 'images/food1.jpg') ||
        (gethistory[i][index].img! == 'images/food3.jpg') ||
        (gethistory[i][index].img! == 'images/food4.jpg') ||
        (gethistory[i][index].img! == 'images/food5.jpg')) {
      return ClipRRect(
        borderRadius: BorderRadius.circular(20),
        child: Container(
